...
local Blip
local morgue = {
  [1] = {["name"] = "Disposal",["x"] = 289.727600097656, ["y"] = -1344.177734375, ["z"] = 24.5377960205078},
  [2] = {["name"] = "Vehicle Morgue",["x"] = 245.443954467773, ["y"] = -1410.55725097656, ["z"] = 30.587495803833},
  [3] = {["name"] = "Morgue",["x"] = 223.208068847656, ["y"] = -1387.89562988281, ["z"] = 30.5365390777588},
}
local hopital = {
  [1] = {["name"] = "Hospital",["x"]=-261.992340087891,["y"]=6333.66162109375,["z"]=32.4210891723633},
  [2] = {["name"] = "Hospital",["x"]=1864.72619628906,["y"]=3702.21899414063,["z"]=33.4716033935547},
  [3] = {["name"] = "Hospital",["x"]=-654.125671386719,["y"]=309.119750976563,["z"]=82.9213256835938},
  [4] = {["name"] = "Hospital",["x"]=-910.559753417969,["y"]=-335.803131103516,["z"]=38.979133605957},
  [5] = {["name"] = "Hospital",["x"]=-427.751342773438,["y"]=-328.891357421875,["z"]=33.1089820861816},
  [6] = {["name"] = "Hospital",["x"]=319.811828613281,["y"]=-557.3583984375,["z"]=28.7437915802002},
  [7] = {["name"] = "Hospital",["x"]=375.525451660156,["y"]=-1443.37231445313,["z"]=29.4315452575684},
  [8] = {["name"] = "Hospital",["x"]=1136.01513671875,["y"]=-1599.89086914063,["z"]=34.6925392150879},
}

local organe = {
  [1] = {["name"] = "Organ Harvesting",["x"] = 425.209655761719, ["y"] = -978.861267089844, ["z"] = 30.7105674743652, ["cost"] = 5000},
  [2] = {["name"] = "Packing of organs",["x"] = 425.209655761719, ["y"] = -978.861267089844, ["z"] = 30.7105674743652, ["cost"] = 5000},
  [3] = {["name"] = "Identification of organs",["x"] = 425.209655761719, ["y"] = -978.861267089844, ["z"] = 30.7105674743652, ["cost"] = 5000},
  [4] = {["name"] = "Sell Organs",["x"] = 425.209655761719, ["y"] = -978.861267089844, ["z"] = 30.7105674743652, ["cost"] = 5000},
}
...
Citizen.CreateThread(function()
  while true do
      ...
      if distance < 5 then
        ...
        if IsControlJustPressed(1,38) then
          ...
          if myjob == 12 then
            ...
            AddTextComponentString("Go get the body")
            ...
            ShowMsgtime.msg = '~r~ You must be at the morgue !'
        ...
        if IsControlJustPressed(1,38) then
          ...
          if myjob == 12 then
            ...
            if org < 1 then
              ...
              ShowMsgtime.msg = '~r~ Carry the corpse to the morgue !'
              ShowMsgtime.time = 150
              SetBlipSprite(Blip, 2)
            else
              ShowMsgtime.msg = '~g~ You already have a ~b~body '
              ShowMsgtime.time = 150
              SetBlipSprite(Blip, 2)
            end
          else
    ...
    if not IsInVehicle() then
      if distance < 5 then
        ShowInfo('~b~ Press ~g~E~b~ to prepare the body', 0)
        if IsControlJustPressed(1,38) then
          TriggerServerEvent("poleemploi:getjobs")
          Wait(100)
          if myjob == 12 then
            ...
            Wait(100)
            if org ~= 0 then
              ShowMsgtime.msg = '~g~ Body Preparation'
              ShowMsgtime.time = 250
              TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
              Wait(2500)
