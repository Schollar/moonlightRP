    ...
    while true do
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.Recolet.distance then
             ShowInfo('~b~Press ~g~E~b~ to pickup', 0)
             if IsControlJustPressed(1, 38) then
                  ...
                  if weedcount < 30 then
                          ShowMsgtime.msg = '~g~ Take ~b~an organ'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ + 1 ~b~organ'
...
-------------------------Bloc Pour rajouter un traitement-------------------------------------------
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement.distance then
             ShowInfo('~b~Press ~g~E~b~ to wrap up ~b~organ', 0)
             if IsControlJustPressed(1, 38) then
                   weedcount = 0
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Wrap ~b~organ'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ + 1 ~b~Wrapped organ'
                          ShowMsgtime.time = 150

                          TriggerEvent("player:looseItem", 13, 1) --13
                          TriggerEvent("player:receiveItem", 14, 1) --14
                  else
                          ShowMsgtime.msg = "~r~ You do not have any organs !"
                          ShowMsgtime.time = 150
                  end
             end
           end
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement2.distance then
             ShowInfo('~b~Press ~g~E~b~ to analyse ~b~Packed organs', 0)
             if IsControlJustPressed(1, 38) then
                   weedcount = 0
                   -- TriggerEvent("player:getQuantity", 6, function(data)
                   --      weedcount = data.count
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Analyser ~b~Packed organs'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ + 1 ~b~Analyzed Organ'
                          ShowMsgtime.time = 150

                          TriggerEvent("player:looseItem", 14, 1) --14
                          TriggerEvent("player:receiveItem", 15, 1) --15
                  else
                          ShowMsgtime.msg = "~r~ You do not have a packed organ !"
                          ShowMsgtime.time = 150
                  end
             end
           end
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement3.distance then
             ShowInfo('~b~Press ~g~E~b~ to ~b~Find customers', 0)
             if IsControlJustPressed(1, 38) then
                   weedcount = 0
                   -- TriggerEvent("player:getQuantity", 6, function(data)
                   --      weedcount = data.count
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Research... ~b~Potential clients...'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ You found a ~b~client'
                          ShowMsgtime.time = 150

                          TriggerEvent("player:looseItem", 15, 1) --16
                          TriggerEvent("player:receiveItem", 16, 1) --17
                  else
                          ShowMsgtime.msg = "~r~ You do not have an organ analyzed !"..weedcount
                          ShowMsgtime.time = 150
                  end
             end
           end
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.vente.distance then
             ...
             if IsControlJustPressed(1, 38) then
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Sell ~b~organe'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ...
                          ShowMsgtime.msg = "~r~You do not have organ !"
                          ShowMsgtime.time = 150
                  end
             end
           end
