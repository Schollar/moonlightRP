    ...
    while true do
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.Recolet.distance then
             ShowInfo('~b~Press ~g~E~b~ to pick up', 0)
             if IsControlJustPressed(1, 38) then
                  ...
                  if weedcount < 30 then
                          ShowMsgtime.msg = '~g~ Take ~b~Ephedrine '
...
-------------------------Bloc Pour rajouter un traitement-------------------------------------------
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement.distance then
             ShowInfo('~b~Press ~g~E~b~ to treat ~b~Illegal material', 0)
             if IsControlJustPressed(1, 38) then
                   weedcount = 0
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Treatment of ~b~Illegal material'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ + 1 ~b~Illegal material 33%'
                          ShowMsgtime.time = 150

                          TriggerEvent("player:looseItem", 9, 1) --9
                          TriggerEvent("player:receiveItem", 10, 1) --10
                  else
                          ShowMsgtime.msg = "~r~ You do not have any illegal material !"
                          ShowMsgtime.time = 150
                  end
             end
           end
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement2.distance then
             ShowInfo('~b~Press ~g~E~b~ to treat ~b~Matière illégale', 0)
             if IsControlJustPressed(1, 38) then
                   weedcount = 0
                   -- TriggerEvent("player:getQuantity", 6, function(data)
                   --      weedcount = data.count
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Traitement ~b~Illegal material'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ShowMsgtime.msg = '~g~ + 1 ~b~Illegal material 66%'
                          ShowMsgtime.time = 150

                          TriggerEvent("player:looseItem", 10, 1) --10
                          TriggerEvent("player:receiveItem", 11, 1) --11
                  else
                          ShowMsgtime.msg = "~r~ You do not have any illegal material 33%!"
                          ShowMsgtime.time = 150
                  end
             end
           end
        ...
        if not IsInVehicle() then
          if distanceWeedFarm < Position.traitement3.distance then
             ...
             if IsControlJustPressed(1, 38) then
                  ...
                  Wait(100)
                  if weedcount ~= 0 then
                          ShowMsgtime.msg = '~g~ Treatment of ~b~Treated Illegal material'
                          ShowMsgtime.time = 250
                          TriggerEvent("vmenu:anim" ,"pickup_object", "pickup_low")
                          Wait(2500)
                          ...
                          ShowMsgtime.msg = "~r~ You do not have any illegal material 66% !"
                          ShowMsgtime.time = 150
                  end
             end
           end
          ...
          if distanceWeedFarm < Position.vente.distance then
             ...
             if IsControlJustPressed(1, 38) then
                  ...
                  if weedcount ~= 0 then
                          ...
                          ShowMsgtime.msg = "~r~ You have no Meth !"
                          ShowMsgtime.time = 150
                  end
             end
           end
