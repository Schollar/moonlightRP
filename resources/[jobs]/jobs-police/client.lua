    ...
    if spawningcar == true then
      ...
      if ServerParking[2] == false then
        ...
        if spawncar == true then
          ...
          drawNotification("Vehicle out, good route")
        else
          drawNotification("Area is too congested")
        end
      else
        drawNotification("Wait before requesting a vehicle")
      end
      spawningcar = false
    end
  end
      ...
      Citizen.Wait(1500)
          ...
          if ( DoesEntityExist( vehicle ) ) then
            ...
            if plate ~= plateveh then
              drawNotification("This vehicle does not belong to you")
            else
              ...
              drawNotification("Vehicled entered")
            end
          else
            drawNotification("No vehicles in front of you")
          end
    end)
end)
