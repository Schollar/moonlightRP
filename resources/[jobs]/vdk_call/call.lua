...
Citizen.CreateThread(function()
    while true do
        ...
        elseif IsControlJustPressed(1, 249) and callActive then
            SendNotification("You declined the call")
            callActive = false
        end
        if haveTarget then
