...
AddEventHandler("tel:addingTel", function(addTel)
	TriggerEvent('es:getPlayerFromId', source, function(user)
		...
		if(result[1] ~= nil) then
			...
			TriggerClientEvent("es_freeroam:notif", source, "~g~ Contact added" .. " " .. result[1].prenom .. " " .. result[1].nom)
		else
			TriggerClientEvent("es_freeroam:notif", source, "~r~ No player has this number")
		end
	end)
end)
