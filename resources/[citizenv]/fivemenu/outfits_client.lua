...
AddEventHandler("vmenu:OutfitsOG", function(target)
  VMenu.ResetMenu(8, "Outfits", "cloth")
  VMenu.AddMenu(8, "Outfits", "cloth") -- default = Header "Texte" sur fond bleu
  VMenu.AddNum(8, "Category", "Outfits", 0, 65, "Change Category")
  VMenu.AddSep(8, OutfitsCat[1])
  VMenu.AddFunc(8, "Validate categories held", "vmenu:OutfitsValidate", {getOpt("Outfits")}, "Validate")
end)

function menuOutfits(id, no, cat)
  VMenu.ResetMenu(8, "Outfits", "cloth")
  VMenu.AddMenu(8, "Outfits", "cloth") -- default = Header "Texte" sur fond bleu
  VMenu.AddFunc(8, "Return", "vmenu:OutfitsOG", {}, "Return")
  VMenu.AddSep(8, cat)
  local i = 0
  ...
  VMenu.AddNum(8, "Outfits", no, 0, i, "Outfits")
  VMenu.AddFunc(8, "Validate your outfit", "vmenu:OutfitsVal", {getOpt(no), id}, "Validate")
end
