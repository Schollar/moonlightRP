...
AddEventHandler("menudrogue:DrogueOG", function(target)
  ...
  VMenu.curItem = 1
  VMenu.AddFunc(14 ,"Buy information", "menudrogue:info",{0},"Buy")
end)
...
AddEventHandler("menudrogue:info",function()
  ...
  VMenu.ResetMenu(14, "", "default")
  VMenu.curItem = 1
  VMenu.AddFunc(14,"Buy information about coke","menudrogue:infocoke",{0},"Buy")
  VMenu.AddFunc(14,"Buy information about meth","menudrogue:infometh",{0},"Buy")
  VMenu.AddFunc(14,"Buy information about organs","menudrogue:infoorg",{0},"Buy")
  VMenu.AddFunc(14,"Buy information about weed","menudrogue:infoweed",{0},"Buy")
end)
...
AddEventHandler("menudrogue:infocoke",function()
  ...
  if cashycash >= coke[1].cost then
    VMenu.AddFunc(14,"Buy coke fields","menudrogue:coke",{0},"Buy")
  end
  if cashycash >= coke[2].cost then
    VMenu.AddFunc(14,"Buy coke Processing","menudrogue:coke",{1},"Buy")
  end
  if cashycash >= coke[3].cost then
    VMenu.AddFunc(14,"Buy coke sale","menudrogue:coke",{2},"Buy")
  end
  if cashycash < coke[1].cost and cashycash < coke[2].cost and cashycash < coke[3].cost then
    VMenu.AddSep(14, "You do not have enough money")
  end
  VMenu.AddFunc(14,"Return","menudrogue:info",{},"Return")
end)

AddEventHandler("menudrogue:coke", function(target, id)
  if id == 0 and not cokefield then
    notif("The coke field has been added to your map")
  ...
  elseif id == 1 and not cokeprocess then
    notif("Coke treatments have been added to your map")
  ...
  elseif id == 2 and not cokesell then
    notif("Sellers of coke have been added to your map")
    ...
    notif("You have already purchased the info")
  end
end)
--fin coke
...
AddEventHandler("menudrogue:infometh",function()
  VMenu.ResetMenu(14, "Informant", "default")
  VMenu.curItem = 1
  if cashycash >= meth[1].cost then
    VMenu.AddFunc(14,"Buy meth fields","menudrogue:meth",{0},"Buy")
  end
  if cashycash >= meth[2].cost then
    VMenu.AddFunc(14,"Buy meth treatment","menudrogue:meth",{1},"Buy")
  end
  if cashycash >= meth[3].cost then
    VMenu.AddFunc(14,"Buy the sale of meth","menudrogue:meth",{2},"Buy")
  end
...
AddEventHandler("menudrogue:meth", function(target, id)
  if id == 0 and not methfield then
    notif("The meth field has been added to your map")
  ...
  elseif id == 1 and not methprocess then
    notif("Meth treatments have been added to your map")
  ...
  elseif id == 2 and not methsell then
    notif("The seller of meth has been added to your map")
...
AddEventHandler("menudrogue:infoorg",function()
  ...
  if cashycash >= organe[1].cost then
    VMenu.AddFunc(14,"Where to harvest organs","menudrogue:org",{0},"Buy")
  end
  if cashycash >= organe[2].cost then
    VMenu.AddFunc(14,"Buy organ treatments","menudrogue:org",{1},"Buy")
  end
  if cashycash >= organe[3].cost then
    VMenu.AddFunc(14,"Buy organ selling","menudrogue:org",{2},"Buy")
  end
...
AddEventHandler("menudrogue:org", function(target, id)
  if id == 0  and not organefield then
    notif("The location to harvest organs has been added to your map")
  ...
  elseif id == 1 and not organeprocess then
    notif("The organ treatments have been added to your map")
  ...
  elseif id == 2  and not organesell then
    notif("The organ seller has been added to your map")
...
AddEventHandler("menudrogue:infoweed",function()
  ...
  if cashycash >= weed[1].cost then
    VMenu.AddFunc(14,"Buy weed fields","menudrogue:weed",{0},"Acheter")
  end
  if cashycash >= weed[2].cost then
    VMenu.AddFunc(14,"Buy weed's treatment","menudrogue:weed",{1},"Acheter")
  end
  if cashycash >= weed[3].cost then
    VMenu.AddFunc(14,"Buy sale of weed","menudrogue:weed",{2},"Acheter")
  end
...
AddEventHandler("menudrogue:weed", function(target, id)
  if id == 0 and not weedfield then
    notif("The weed field has been added to your map")
  ...
  elseif id == 1 and not weedprocess then
    notif("The treatment of weed has been added to your map")
  ...
  elseif id == 2 and not weedsell then
    notif("The seller of weed has been added to your map")
